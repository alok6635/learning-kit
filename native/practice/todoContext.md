...
const Todo = () => {
  const {handleAdd,handleDel,handleEdit,editIndex, display, inp, setInp}=  useContext(todoContext)
    return (
        <>
...
const TodoStore = (props) => {
   ...
   return (
        <todoContext.Provider value={{ handleAdd, handleDel, handleEdit, editIndex, display, inp, setInp }}>
            {props.children}
...
import TodoStore from './componet/TodoStore'
const App = () => {
  return (
    <TodoStore>
    <Todo/>
